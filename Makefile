...
.PHONY: charts
charts: TMP := $(shell mktemp -d)
charts: yq helm-docs kustomize ## Generate helm charts and their documentations
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kubestatic-builder
	$(CONTAINER_TOOL) buildx use kubestatic-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm kubestatic-builder
	rm Dockerfile.cross
