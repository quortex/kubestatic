...
// Source: internal/provider/aws/ec2Client.go
//
// Generated by this command:
//
//	mockgen -source=internal/provider/aws/ec2Client.go -destination=internal/provider/aws/mocks/mock_ec2Client.go -package=mocks
//
